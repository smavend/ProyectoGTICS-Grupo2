...
public class CorreoAutoregistro {
    ...
    private String getHTMLContent(String user, Paciente paciente, String link) {
        ...
        htmlContent = "<html lang=\"en\" xmlns:th=\"http://www.thymeleaf.org\">\n" +
                ...
                "  </body>\n" +
                "</html>";
        htmlContent = htmlContent.replace("%nombre%",paciente.getNombre());
        htmlContent = htmlContent.replace("%apellido%", paciente.getApellidos());
        htmlContent = htmlContent.replace("%correo%", paciente.getCorreo());
