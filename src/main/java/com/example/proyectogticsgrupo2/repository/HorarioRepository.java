...
public interface HorarioRepository extends JpaRepository<Horario, String> {
    ...
    @Query(nativeQuery = true, value = "select addtime(h.disponibilidad_inicio, sec_to_time(d.duracion_cita_horas*3600)) as horario1, \n" +
            "addtime(h.comida_fin, sec_to_time(d.duracion_cita_horas*3600)) as horario2, \n" +
            "addtime(h.comida_fin, sec_to_time(d.duracion_cita_horas*3600*3)) as horario3 from horario h \n" +
