...
public class CorreoPacientePassw {
    public void enviarCorreo(String correo, String nombre, String link, String id, String token) {
        ...
        try {
            ...
            message.setSubject("Cambio de contraseña | clínica InterPUCP");
